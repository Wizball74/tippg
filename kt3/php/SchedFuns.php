                    ...
                    foreach ($rows as $row)
                    {
                        if (strpos($row->getAttribute('class'), 'fest') !== false) // nur Zeilen mit relevanten Daten
                        {
                            ...
                            $sched[$_sptag][$_nr++] = array(
						        ...
						        'T1n' => $t1,
						        'T2n' => $t2,
						        'T1' => findTeam($_teams, $t1), //$_teams[$t1],
						        'T2' => findTeam($_teams, $t2), //$_teams[$t2],
